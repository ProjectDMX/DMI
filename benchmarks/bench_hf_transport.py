...
def _run_one_greedy(model, input_ids, attention_mask,
    ...
    from dmi.adapters.huggingface.generation import generate_greedy_with_monitoring, GreedyGenerateTimings
...
def _run_mode(mode: str, model, input_ids, attention_mask,
    ...
    try:
        ...
        try:
            from dmi.adapters.huggingface.generation import _prepare_profile_times, print_prepare_profile
        ...
        try:
            from dmi.adapters.huggingface.generation import _prepare_profile_times
