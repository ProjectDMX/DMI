...
```bash
STORAGE_LABEL=disk PROJ_DMI_MODE=ring_db bash experiments/offline_inference/ring_db_storage_bundle/run_ring_db_storage_e2e_qwen3_4b_local.sh
STORAGE_LABEL=tmpfs PROJ_DMI_MODE=ring_db bash experiments/offline_inference/ring_db_storage_bundle/run_ring_db_storage_e2e_qwen3_4b_local.sh
STORAGE_LABEL=disk PROJ_DMI_MODE=ring_null bash experiments/offline_inference/ring_db_storage_bundle/run_ring_db_storage_e2e_qwen3_4b_local.sh
```
