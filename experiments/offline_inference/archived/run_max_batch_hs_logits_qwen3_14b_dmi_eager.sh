...
BASELINES=(
    ...
    "proj_dmi_eager_ring5g"
    "proj_dmi_eager_ring10g"
)
...
RESULTS_DIR="${PROJECT}/experiments/offline_inference/results/max_batch_${MODEL}_${DATASET}_${CAPTURE_MODE}_synthetic_dmi_eager${TAG_SUFFIX}_${RUN_TAG}"
...
search_baseline() {
    local baseline="$1"
    local start_probe="${SEARCH_HIGH_DMI}"
    local fallbacks
