...
| DMI integration | branch `dmi-v0.27.1-gpt-oss`; commit `a08206f1dce85cc9211a1cabb4fb02015eaa7a09` |
...
| Lite cell | TP1, V1 offline API, native MXFP4, public eager/default graph and ClickHouse cases generated for H100 |
...
| Full local lite gate | GPT-OSS, version compatibility, release-matrix, and compare-runner contracts: `62 passed` |
| Lint/compile | new model, compare model, and focused test pass ruff and Python compilation |
| H100 public case | generated as `public-gpt_oss-tp1-eager-graph` |
| H100 storage cases | generated as `storage-gpt_oss-{eager,cudagraph}-tp1` with 2 GiB ring buffers |
