...
| DMI integration | branch `dmi-v0.27.1-minimax-m27`; commit `1dbe25044647ed623b6f48ecb8d8d079072bd2db` |
...
| Lite cell | TP4/PP1/DP1, no EP/SP/EPLB/context parallelism, V1 offline API, FP8 weights with BF16 activations, public and ClickHouse cases generated for H100 |
...
| Full cumulative lite gate | GPT-OSS, Qwen3-MoE, Llama 4, Qwen3.6, GLM-5.2, MiniMax-M2.7, version, matrix, comparator, and black-box contracts: `307 passed` |
...
| H100 public case | generated as `public-minimax_m27-tp4-eager-graph` with two deterministic cases |
| H100 storage cases | generated as `storage-minimax_m27-{eager,cudagraph}-tp4` with per-rank 2 GiB ring buffers |
